...
class Solver(object):
    def __init__(self, args, batch_size=64,
                 ...
                 learning_rate=0.0002, interval=100,
                 optimizer='adam',
                 num_k=4, all_use=False,
    ...
    def set_optimizer(self, which_opt='momentum', lr=0.001, momentum=0.9):
        if which_opt == 'momentum':
            self.opt_g = optim.SGD(self.G.parameters(),lr=lr, momentum=momentum, weight_decay=0.0005)
            self.opt_c1 = optim.SGD(self.C1.parameters(),lr=lr, momentum=momentum ,weight_decay=0.0005)
            self.opt_c2 = optim.SGD(self.C2.parameters(),lr=lr, momentum=momentum ,weight_decay=0.0005)
